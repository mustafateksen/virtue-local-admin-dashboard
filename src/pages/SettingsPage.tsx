...
export const SettingsPage: React.FC = () => {
  ...
  const renderAppearanceSettings = () => (
    <div className="space-y-6">
      ...
      <div>
        <h3 className="text-lg lg:text-xl font-semibold text-foreground mb-4">Display</h3>
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
            <div>
              <p className="text-base lg:text-lg font-medium text-foreground">Compact Mode</p>
              <p className="text-sm lg:text-base text-muted-foreground">Reduce spacing and padding</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
          ...
          <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
            <div>
              <p className="text-base lg:text-lg font-medium text-foreground">Animations</p>
              <p className="text-sm lg:text-base text-muted-foreground">Enable smooth transitions</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input type="checkbox" className="sr-only peer" defaultChecked />
              <div className="w-11 h-6 bg-muted peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary/25 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
